...
int main() {
    ...
    (outputLs == -1) ? printf("Number not present in array") : printf("Number is present at index: %d", outputLs);

    printf("\n");
    printf("\n");

    printf("Binary Search Output- \n");
    (outputBs == -1) ? printf("Number not present in array") : printf("Number is present at index: %d", outputBs);
    return 0;
